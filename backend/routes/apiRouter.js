...
const { pexelsVideoApi, pexelsPhotoApi } = require('../controllers/api/pexelsApiController');
...
// Get Pexels Video
router.post('/pexelsvideo', pexelsVideoApi);
// Get Pexels Photo
router.post('/pexelsphoto', pexelsPhotoApi);
